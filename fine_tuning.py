...
feature_aliginment_training_step_1_CPU_GPU_SPLIT(clip_parameters,optim_parameters,connector_llm_parameters,per_warm=0.2,image_size=224,batch_size=2,rand_seed=42,MAX_EPOC=3,MAX_LENGTH=256,VERSION=2000, save=True)